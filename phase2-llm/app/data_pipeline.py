...
class DataPipeline:
    ...
    def load_catalog(self) -> pd.DataFrame:
        ...
        raise FileNotFoundError("Prepared catalog not found. Call /ingest first.")
    ...
    def _load_raw_df(self) -> pd.DataFrame:
        ...
        try:
            ...
            raise RuntimeError(f"Unable to fetch dataset and no local CSV at {RAW_FILE}.") from exc
    ...
    def _prepare(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        mapped_df["location"] = mapped_df["location"].replace({"bengaluru": "bangalore", "new delhi": "delhi"})
        ...
        mapped_df = mapped_df.drop_duplicates(subset=["restaurant_name", "location", "cuisine"], keep="first")
