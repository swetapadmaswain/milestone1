...
PROMPT_VERSION = "v1-groq-phase4"

API_KEY = os.getenv("PHASE4_API_KEY", "").strip()
RATE_LIMIT_PER_MIN = int(os.getenv("PHASE4_RATE_LIMIT_PER_MIN", "120"))
CACHE_TTL_SECONDS = int(os.getenv("PHASE4_CACHE_TTL_SECONDS", "120"))
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "").strip()
GROQ_MODEL = os.getenv("GROQ_MODEL", "llama-3.1-8b-instant").strip()
LLM_TIMEOUT_SECONDS = float(os.getenv("PHASE4_LLM_TIMEOUT_SECONDS", "8.0"))
